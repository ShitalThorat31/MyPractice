package com.example.mypractice.MemeShare
...
import kotlinx.android.synthetic.main.activity_sharememe.*



class MainActivity_ShareMeme : AppCompatActivity() {

    var currentMemeUrl: String? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_sharememe)
